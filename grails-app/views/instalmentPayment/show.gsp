...
<html>
    <head>
        ...
        <title>Ver instalmentPayment</title>
    </head>
    <body>
        <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
            ...
            <div class="card card-outline-success">
                <div class="card-header pb-0 pb-lg-0">
                    <h5 class="card-title text-white"><i class="fa fa-eye"></i>&nbsp;instalmentPayment
                        <g:link class="btn btn-xs btn-outline-light float-right waves-effect waves-light"
                                action="edit" resource="${this.instalmentPayment}">
                ...
                <div class="card-body">
                    <f:display bean="instalmentPayment" />
                </div>

                <div class="card-footer d-none">
                    <g:form resource="${this.instalmentPayment}" method="DELETE">
