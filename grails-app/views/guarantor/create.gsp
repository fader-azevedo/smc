...
<html>
    <head>
        ...
        <title>Registar guarantor</title>
    </head>
    <body>
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
        ...
        <div class="card card-outline-success">
            <div class="card-header pb-0 pb-lg-0">
                <h5 class="card-title text-white"><i class="fa fa-pencil-alt"></i>&nbsp;Registar guarantor</h5>
            </div>
            <g:form resource="${this.guarantor}" method="POST">
                <div class="card-body">
