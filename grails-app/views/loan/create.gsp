            ...
            <div class="card-body" id="div-form-loan">
                <div class="wizard-steps bg-white mb-lg-4 mb-4">
                    ...
                    <div class="wizard-step active col-12 col-sm-6">
                        <div class="wizard-step-icon d-block mx-auto pt-1"><i class="mdi mdi-credit-card-plus"></i>
                        </div>
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text bg-white w-100 p-0">
                                                            <div class="container-image py-1 px-1 mt-0">
                                                                ...
                                                                <label class="btn btn-xs btn-success" type="button"><i
                                                                        class="fa fa-upload"></i></label>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <textarea required="required" placeholder="descrição"
                                                              class="form-control text-dark f-s-12" id="description"
                                                    ...
                                                    <div class="input-append">
                                                        <span class="input-group-text none-border h-100 d-flex flex-column justify-content-between"
                                                            ...
                                                            <a href="javascript:void(0)"
                                                               ...
                                                               id="plus-guarantee"><i class="fa fa-plus"></i></a>
                                                            <a href="javascript:void(0)"
                                                               class="btn btn-danger btn-xs waves-effect waves-red btn-minus-guarantee"
                                                               id="minus-guarantee"><i class="fa fa-minus"></i></a>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header pb-2 pt-2">
                <h5 class="modal-title" id="client-modalLabel"><i
                        class="mdi mdi-account-edit"></i>&nbsp;Registar cliente</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group-sm">
                                ...
                                <input type='text' class="form-control form-control-sm date" name="birthDate"
                                       id="birthDate"/>
                            </div>
                            ...
                            <div class="form-group-sm">
                                ...
                                <input type="text" class="form-control form-control-sm" name="documentNumber"
                                       id="documentNumber" required value=";sad">
                            </div>
                        ...
                        <div class="form-group-sm col-12">
                            ...
                            <input type="text" class="form-control form-control-sm typeahead" id="profession"
                                   name="profession">
                        </div>
                    </div>
                </div>
