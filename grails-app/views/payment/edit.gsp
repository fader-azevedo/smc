        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
            ...
            <div class="card card-outline-success">
                <div class="card-header pb-0 pb-lg-0">
                    <h5 class="card-title text-white"><i class="fa fa-edit"></i>&nbsp;Editar payment</h5>
                </div>
                <g:form resource="${this.payment}" method="PUT">
                    ...
                    <div class="card-footer">
                        <g:link action="show" resource="${this.payment}" class="btn btn-sm btn-outline-secondary waves-effect waves-light"><i
